        ...
        for i, l in enumerate(lines):
            ...
            if line.startswith('skill '):
                ...
                if len(line.split(' ', 1)) == 1:
                    ...
                    skill_id = line.split(' ')[1]
                    skill_type = line.split(' ')[2] if 2 < len(line.split(' ')) else "base"
                    augment_id = line.split(' ')[3] if 3 < len(line.split(' ')) else ""
                    parent_id = ""
                ...
                if previous_line and ((not previous_line.startswith('skill')) and (not previous_line.startswith('dynamic_rule'))):
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(prog='skill-parser.py', description='.skill file parser for Diabotical')
    parser.add_argument('src_directory', type=Path, help="this directory will be recursively searched for .skill files")
